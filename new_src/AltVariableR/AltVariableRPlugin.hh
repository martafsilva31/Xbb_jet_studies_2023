...
namespace contrib {
  ...
  class AltVariableRPlugin : public JetDefinition::Plugin {

  public:
    /// Type of clustering
    ///
    /// Since version 1.2.0 of AltVariableR, the clustering is treated as
    ...
    /// (These are initialized in AltVariableRPlugin.cc.)
    ...
    ///    contrib::AltVariableRPlugin vr_plugin(rho,min_r,max_r,clust_type);
    ...
    AltVariableRPlugin(double rho, double min_r, double max_r, ClusterType clust_type, bool precluster = false,
